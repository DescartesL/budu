...
import com.budu.service.RedisService;
import com.budu.vo.*;
import com.budu.common.*;
import com.budu.entity.*;
import com.budu.enums.SearchModelEnum;
import com.budu.enums.YesOrNoEnum;
import com.budu.exception.BusinessException;
import com.budu.mapper.*;
import com.budu.service.ArticleService;
import com.budu.service.SystemConfigService;
import com.budu.strategy.context.SearchStrategyContext;
import com.budu.util.*;
import com.budu.dto.ArticleDTO;
...
import static com.budu.common.RedisConstants.*;
import static com.budu.common.ResultCode.*;
...
public class ArticleServiceImpl extends ServiceImpl<ArticleMapper, BlogArticle> implements ArticleService {
    ...
    public ResponseResult articleSeo(List<Long> ids) {
        ...
        ids.forEach(item -> {
            String url = "http://www.budut.com/article/" + item;
